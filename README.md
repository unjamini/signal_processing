...
Отмечу, что в репозитории помимо jupyter notebook есть 2 .py файла, дублирующих содержание работы. В *data_prepataion* - часть с выделением значений признаков и сборкой датасета, в *classification* - часть с классификацией.
